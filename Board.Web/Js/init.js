...
define(function (require, exports, module) {
    ...
    require('./zic-js/plus-jq/ui_19/jquery.ui.core')($);
    require('./zic-js/plus-jq/ui_19/jquery.ui.widget')($);
    require('./zic-js/plus-jq/ui_19/jquery.ui.position')($);
    require('./zic-js/plus-jq/ui_19/jquery.ui.mouse')($);
    require('./zic-js/plus-jq/ui_19/jquery.ui.resizable')($);
    require('./zic-js/plus-jq/ui_19/jquery.ui.sortable')($);
    require('./zic-js/plus-jq/ui_19/jquery.ui.selectable')($);
    require('./zic-js/plus-jq/ui_19/jquery.ui.draggable')($);
    require('./zic-js/plus-jq/ui_19/jquery.ui.dialog')($);
    require('./zic-js/plus-jq/ui_19/jquery.ui.button')($);
    require('./zic-js/plus-jq/ui_19/jquery.ui.datepicker')($);
